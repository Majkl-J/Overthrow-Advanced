...
"Land_CampingTable_F","Land_CampingChair_V2_F"];
...
OT_Buildables = [
	...
	["Workshop",1000,[
		...
		["Land_fs_feed_F",[2,-3,0],0,1,0,[],"","",true,false]
...
OT_Placeables = [
	...
	["Camo Nets",40,["Land_MedicalTent_01_white_generic_open_F","Land_MedicalTent_01_white_IDAP_open_F","Land_TentHangar_V1_F","CamoNet_INDP_open_F","CamoNet_INDP_F","CamoNet_ghex_F","CamoNet_ghex_open_F","CamoNet_ghex_big_F"],[0,7,2],"Large && terribly flimsy structures that may or may not obscure your forces from airborne units."],
